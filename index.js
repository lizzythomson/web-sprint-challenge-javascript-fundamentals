...
// The nestedFunction can access variables in myFunction as well as global variables like external, due to scope and closures. Scope determines the accessibility of variables and is like a one way mirror allowing nestedFunction to reach out and grab outer variables. When the nestedFunction is created it creates a closure allowing it to remember the environment (including the internal variable) in which it was created and use those variables even if it is executed later.
